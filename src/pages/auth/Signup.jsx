...
const Signup = () => {
  ...
  const Onsubmit = async (data, e) => {
    ...
    const SendAdmin = async () => {
      const url = "https://n1financebackend.onrender.com/api/registrationSuccessfulEmail"
      const FormData = {
        email: data.email
      }
    ...
    const url = 'https://n1-finance-back-end.vercel.app/api/register'
    const FormData ={
  ...
  return (
    <div className="w-full h-screen">
      ...
      <div className="w-full phone:h-24 phone:gap-3 phone:flex-col phone:justify-center phone:py-4 h-14 text-white px-48 flex items-center justify-between bg-[#0e1120]">
        <div className="w-max flex items-center gap-4">
        <p className="flex gap-5 items-center text-white">&copy;  Copy Rights {currentYear}. All Rights Reserved N1Finance</p>
        </div>
