...
const NewWithdrawal = () => {
    ...
    .object({ check: z.boolean().refine((val) => val === true, {
     ...
     const { register, handleSubmit, formState: { errors }, setError } = useForm({
      ...
      const handleGetUser = async () => {
        setLoading(true)
        await axios.get(`https://n1-finance-back-end.vercel.app/api/userdata/${id}`)
            .then(response => {
                setLoading(false)
  ...
  const url = `https://n1-finance-back-end.vercel.app/api/requestwithdrawcode/${id}`
  const urlll = `https://n1-finance-back-end.vercel.app/api/withdraw/${id}`
  const urlprofit = `https://n1-finance-back-end.vercel.app/api/transferprofittoaccount/${id}`
  const urlemail = `https://n1-finance-back-end.vercel.app/api/withdrawalemailsend/${id}`
